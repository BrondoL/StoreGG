...
export default function SignUpPhoto() {
    ...
    const onSubmit = async () => {
        ...
        if(favorite === ""){
            toast.error("Pilih Game Favorite !")
            return false;
        }
            ...
            <form action="">
                <div className="form-input d-md-block d-flex flex-column">
                    <div>
                        ...
                        <div className="pt-50 pb-50">
                            <label htmlFor="category" className="form-label text-lg fw-medium color-palette-1 mb-10">Favorite
                                Game</label>
                            <select id="category" className="form-select d-block w-100 rounded-pill text-lg"
                    ...
                    <div className="button-group d-flex flex-column mx-auto">
                        {loading ? <button type="button" className="btn btn-create fw-medium text-lg text-white rounded-pill mb-16"
                            role="button">Loading...</button> : <button type="button" className="btn btn-create fw-medium text-lg text-white rounded-pill mb-16"
